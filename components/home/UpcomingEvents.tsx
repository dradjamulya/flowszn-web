    ...
    <section style={{ padding: '80px 0', background: '#EFEDE8' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 48px' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '8px' }}>
          <h2 style={{
            fontFamily: 'var(--font-playfair)', fontSize: 'clamp(26px, 4vw, 38px)',
            color: 'var(--text-primary)', lineHeight: '1.2'
          }}>
            Archive Highlights
          </h2>
          <a href="/archive" style={{ fontSize: '13px', color: 'var(--text-secondary)', textDecoration: 'none', whiteSpace: 'nowrap', marginTop: '8px' }}>
            View Full Archive →
          </a>
        </div>

        <p style={{ fontSize: '13px', color: 'var(--text-secondary)', marginBottom: '48px', lineHeight: '1.6', maxWidth: '440px' }}>
          See the beautiful moments and vibrant energy captured in our previous events,
          and get a feel for the ambience you can expect!
        </p>
        ...
        <div className="events-grid">
          {events.map((event, i) => (
            <div key={i} style={{
              ...
              {/* Image — no dark frame, clean card */}
              ...
              <div style={{ padding: '20px', flex: 1, display: 'flex', flexDirection: 'column', gap: '8px' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  ...
                  <span style={{ fontSize: '12px', color: 'var(--text-secondary)', whiteSpace: 'nowrap', marginLeft: '8px' }}>
                    {event.duration}
                  </span>
                </div>
